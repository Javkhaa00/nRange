      ...
      <div className="footer--download">
        <div className="footer--download--logo">
          <img
            ...
            alt="footer-nrange-logo"
          />
        </div>
        <span className="footer--download--title">Download now for free</span>
        <span className="footer--download--desc">
          Join the 1million+ golfers today
        </span>
          ...
          <div className="footer--extra--wrapper--logos">
            <div className="footer--extra--wrapper--logos--nrange">
              <img
                ...
                src="/assets/nRange-logo-black.png"
                alt="footer-logo"
              />
            </div>
      ...
      <div className="footer--all-rights">
        <div className="footer--all-rights--wrapper">
          <span className="footer--all-rights--wrapper--desc">
            Copyright © 2008-2020 nRange Golf GPS Developed by Infinite
            Solutions, LLC nRange and nRange Golf GPS are trademarks or
            registered trademarks of, LLC in the United States and other
            countries.
